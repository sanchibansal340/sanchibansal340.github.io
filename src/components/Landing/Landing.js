        ...
        >
          ...
          <Grid2 container spacing={3} sx={{ alignItems: "center" }}>
            ...
            <Grid2 item xs={12} md={5} sx={{ textAlign: "left" }}>
              ...
              <Typography variant="h3" sx={{ fontWeight: "bold", color: "#55c2a6" }}>
                Sanchi Bansal
              </Typography>
              <Typography variant="body1" sx={{ mt: 1, fontSize: '1.25rem' }}>
                Turning coffee into code and ideas into reality! 🚀 <br />
                I’m a Software Engineer specializing in all things web, <br />
                crafting digital magic with React, Python, and AWS.
              </Typography>
              {/* Links */}
              <Box sx={{ mt: 3, fontSize: '1.25rem' }}>
                {jsonData.socials.map(social => (
                  <a href={social.url} style={{ color: "#55c2a6", marginRight: "1rem" }} target="_blank">
                      &#10100;{social.name}&#10101;
                  </a>
                ))}
                <p>
                  Mail at: <a href="mailto:sanchibansal340@gmail.com" style={{ color: "#55c2a6", marginRight: "1rem" }}>sanchibansal340@gmail.com</a>
                </p>
              </Box>
            </Grid2>
            ...
            <Grid2 item xs={12} md={5} display="flex" justifyContent="center">
            <Box 
              sx={{ 
